...
export function MyHeader () {
    ...
    return(
        <>
            {pathname === '/talkToMe' ? <div id="header"  className="z-10 fixed w-[100%] h-[5.9rem] bg-black to-transparent flex justify-between items-center ps-[10.5rem] pe-[32.9rem] border-b-[0.1rem] border-y-grey">

...
export function MyHeader () {
    ...
    return(
        <>
            <header className="z-10 fixed w-[100%] h-[5.9rem] bg-black to-transparent flex justify-between items-center ps-[10.5rem] pe-[32.9rem] border-b-[0.1rem] border-y-grey">
                ...
                <ul className="flex h-[100%] justify-between w-[56.5rem] items-center text-green_clean">
                    <li><a href="" className="text-grey cursor-not-allowed" id="home">Home</a></li>
